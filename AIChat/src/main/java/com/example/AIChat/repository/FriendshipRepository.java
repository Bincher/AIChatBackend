...
public interface FriendshipRepository extends JpaRepository<FriendshipEntity, Integer> {
    ...
    List<FriendshipEntity> findByFriendIdAndStatus(Integer friendId, String status);
    List<FriendshipEntity> findByUserIdAndStatus(Integer friendId, String status);
